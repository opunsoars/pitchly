...
setup(
    ...
    url='https://github.com/opunsoars/pitchly',
    ...
    project_urls={
        ...
        'Changelog': 'https://pitchly.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/opunsoars/pitchly/issues',
    },
    keywords=[
